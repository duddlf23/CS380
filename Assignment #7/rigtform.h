...
public:
  ...
  static Cvec3 get_d(Cvec3 c0, Cvec3 c1, Cvec3 c2) {
	  return (c2 - c0) * 0.16666667 + c1;
  }
  static Cvec3 get_e(Cvec3 c0, Cvec3 c1, Cvec3 c2) {
	  return (c2 - c0) * (-0.16666667) + c1;
  }

  static Quat get_d(Quat q0, Quat q1, Quat q2) {
	  if(q2 == q0) return q1;

	  return cn(q2 * inv(q0)).power(0.16666667) * q1;
  }

  static Quat get_e(Quat q0, Quat q1, Quat q2) {
	  if (q2 == q0) return q1;
